...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var apiConfig={sqlCreate:'/api/sql/Create',sqlAuthenticate:'/api/sql/Authenticate',sqlCheck:'/api/sql/Check',mongoPost:'/api/mongo/posts',mongoPut:'/api/mongo/posts/:id',mongoDelete:'/api/mongo/posts/:id',mongoGetAll:'/api/mongo/posts',mongoGet:'/api/mongo/posts/:id'},environment={mysql:!0,mongodb:!0,socketio:!1};exports.apiConfig=apiConfig,exports.environment=environment;
...
"use strict";
var _express=__webpack_require__(6),_express2=_interopRequireDefault(_express),_bodyParser=__webpack_require__(7),_bodyParser2=_interopRequireDefault(_bodyParser),_path=__webpack_require__(0),_path2=_interopRequireDefault(_path),_config=__webpack_require__(8),_config2=_interopRequireDefault(_config),_routes=__webpack_require__(9),_routes2=_interopRequireDefault(_routes),_apiConfig=__webpack_require__(3);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}var app=(0,_express2.default)();if('dev'===process.env.NODE_ENV){var webpackMiddleware=__webpack_require__(17),webpackHotMiddleware=__webpack_require__(18),webpack=__webpack_require__(1),webpackDevConfig=__webpack_require__(19),compiler=webpack(webpackDevConfig),middleware=webpackMiddleware(compiler,{publicPath:webpackDevConfig.output.publicPath,stats:{colors:!0}});app.use(middleware),app.use(webpackHotMiddleware(compiler)),app.get('/',function(req,res){res.sendFile(_path2.default.join(__dirname,'../public/index.html'))})}else app.use(_express2.default.static('public')),app.get('/',function(req,res){res.redirect('/pageA')}),app.get('/PageA',function(req,res){res.sendFile(_path2.default.join(__dirname,'public/pageA/index.html'))}),app.get('/PageB',function(req,res){res.sendFile(_path2.default.join(__dirname,'public/pageB/index.html'))}),app.get('/PageC',function(req,res){res.sendFile(_path2.default.join(__dirname,'public/pageC/index.html'))});if(_apiConfig.environment.mongodb){var mongoose=__webpack_require__(2);if(mongoose.Promise=global.Promise,'test'!==process.env.NODE_ENV){mongoose.connect(process.env.MONGODB_URI||'mongodb://localhost/'+'users')}}app.use(_bodyParser2.default.json()),app.use(function(err,req,res,next){res.status(422).send({error:err.message}),next()}),(0,_routes2.default)(app,_apiConfig.environment),app.listen(_config2.default.port,_config2.default.host,function(){console.info('Express listening on port',_config2.default.port),console.log(process.env.NODE_ENV)});
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var _process=process,env=_process.env,nodeEnv=exports.nodeEnv=env.NODE_ENV||'development';exports.default={port:env.PORT||8080,host:env.HOST||'0.0.0.0',get serverUrl(){return'http://'+this.host+':'+this.port}};
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0});var _controllerSql=__webpack_require__(10),_controllerMongo=__webpack_require__(15),_controllerMongo2=_interopRequireDefault(_controllerMongo),_apiConfig=__webpack_require__(3);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}var routes=function(app,environment){environment.mysql&&(app.post(_apiConfig.apiConfig.sqlCreate,_controllerSql.sqlCreate),app.post(_apiConfig.apiConfig.sqlAuthenticate,_controllerSql.sqlAuthenticate),app.post(_apiConfig.apiConfig.sqlCheck,_controllerSql.sqlCheck)),environment.mongodb&&(app.post(_apiConfig.apiConfig.mongoPost,_controllerMongo2.default.create),app.put(_apiConfig.apiConfig.mongoPut,_controllerMongo2.default.edit),app.delete(_apiConfig.apiConfig.mongoDelete,_controllerMongo2.default.delete),app.get(_apiConfig.apiConfig.mongoGetAll,_controllerMongo2.default.getusers),app.get(_apiConfig.apiConfig.mongoGet,_controllerMongo2.default.getuser))};exports.default=routes;
...
"use strict";
Object.defineProperty(exports,'__esModule',{value:!0}),exports.sqlCheck=exports.sqlAuthenticate=exports.sqlCreate=void 0;var _store=__webpack_require__(11),_store2=_interopRequireDefault(_store);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}var sqlCreate=function(req,res){_store2.default.createUser({username:req.body.username,password:req.body.password,res:res})},sqlAuthenticate=function(req,res){_store2.default.authenticateUser({username:req.body.username,password:req.body.password,res:res})},sqlCheck=function(req,res){_store2.default.checkUserExistByUsername({username:req.body.username}).then(function(_ref){var success=_ref.success;console.log(success),success?(console.log('mySQL User Exists'),res.send('mySQL User Exists')):(console.log('mySQL User does not exists'),res.send('mySQL User does not exists'))})};exports.sqlCreate=sqlCreate,exports.sqlAuthenticate=sqlAuthenticate,exports.sqlCheck=sqlCheck;
...
"use strict";
var _slicedToArray=function(){function sliceIterator(arr,i){var _arr=[],_n=!0,_d=!1,_e=void 0;try{for(var _s,_i=arr[Symbol.iterator]();!(_n=(_s=_i.next()).done)&&(_arr.push(_s.value),!(i&&_arr.length===i));_n=!0);}catch(err){_d=!0,_e=err}finally{try{!_n&&_i['return']&&_i['return']()}finally{if(_d)throw _e}}return _arr}return function(arr,i){if(Array.isArray(arr))return arr;if(Symbol.iterator in Object(arr))return sliceIterator(arr,i);throw new TypeError('Invalid attempt to destructure non-iterable instance')}}(),knex=__webpack_require__(12)(__webpack_require__(13)),crypto=__webpack_require__(14);function randomString(){return crypto.randomBytes(4).toString('hex')}function saltHashPassword(_ref){var password=_ref.password,_ref$salt=_ref.salt,salt=_ref$salt===void 0?randomString():_ref$salt,hash=crypto.createHmac('sha512',salt).update(password);return{salt:salt,hash:hash.digest('hex')}}module.exports={createUser:function createUser(_ref2){var username=_ref2.username,password=_ref2.password,res=_ref2.res;console.log('Creating User...'),this.checkUserExistByUsername({username:username}).then(function(_ref3){var success=_ref3.success;if(!success){var _saltHashPassword=saltHashPassword({password:password}),salt=_saltHashPassword.salt,hash=_saltHashPassword.hash;return knex('User').insert({username:username,encrypted_password:hash,salt:salt}).then(function(){res.send('mySQL User Created'),console.log('mySQL User Created')})}return res.send('mySQL User Already Existed'),console.log('mySQL User Already Existed'),{success:!1}})},checkUserExistByUsername:function checkUserExistByUsername(_ref4){var username=_ref4.username;return console.log('Checking Username'),knex('User').where({username:username}).then(function(user){return 0===user.length?{success:!1}:{success:!0}})},authenticateUser:function authenticateUser(_ref5){var username=_ref5.username,password=_ref5.password,res=_ref5.res,userExist=!1,passwordPass=!1;return knex('User').where({username:username}).then(function(_ref6){var _ref7=_slicedToArray(_ref6,1),user=_ref7[0];if(!user)console.log('User doesn\'t exists.');else{userExist=!0;var _saltHashPassword2=saltHashPassword({password:password,salt:user.salt}),hash=_saltHashPassword2.hash;hash===user.encrypted_password?(passwordPass=!0,console.log('Success.')):console.log('Wrong password.')}}).then(function(){userExist&&passwordPass?res.send('Login Success'):res.send('Login Failed')})}};
...
"use strict";
module.exports={client:'mysql',connection:{user:'root',password:'password',database:'testSQLdb'}};
...
"use strict";
var _User=__webpack_require__(16),_User2=_interopRequireDefault(_User);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}module.exports={create:function create(req,res,next){var userProps=req.body;_User2.default.create(userProps).then(function(user){return res.send(user)}).then(function(){console.log('mongodb User created')}).catch(next)},edit:function edit(req,res,next){var userId=req.params.id,userProps=req.body;_User2.default.findByIdAndUpdate({_id:userId},userProps).then(function(){return _User2.default.findById({_id:userId})}).then(function(user){return res.send(user)}).catch(next)},delete:function _delete(req,res,next){var userId=req.params.id;_User2.default.findByIdAndRemove({_id:userId}).then(function(user){return res.status(204).send(user)}).catch(next)},getusers:function getusers(req,res,next){_User2.default.find({}).then(function(users){return res.send(users)}).catch(next)},getuser:function getuser(req,res,next){var userId=req.params.id;_User2.default.findOne({_id:userId}).then(function(user){return res.send(user)}).catch(next)}};
...
"use strict";
var _mongoose=__webpack_require__(2),_mongoose2=_interopRequireDefault(_mongoose);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj}}var UserSchema=new _mongoose.Schema({username:String,password:String}),User=_mongoose2.default.model('user',UserSchema);module.exports=User;
...
"use strict";
var path=__webpack_require__(0),webpack=__webpack_require__(1),HtmlWebpackPlugin=__webpack_require__(20),DashboardPlugin=__webpack_require__(21),autoprefixer=__webpack_require__(33),CopyWebpackPlugin=__webpack_require__(34),loaders=__webpack_require__(35),hotMiddlewareScript='webpack-hot-middleware/client';module.exports={entry:{bundle:[hotMiddlewareScript,'./client/index/index.js']},output:{filename:'bundle.js',path:path.join(__dirname,'public'),publicPath:'/'},devtool:'eval',module:{loaders:loaders},node:{fs:'empty'},plugins:[new webpack.HotModuleReplacementPlugin,new webpack.NoEmitOnErrorsPlugin,new HtmlWebpackPlugin({template:'./client/template.html',filename:'index.html'}),new DashboardPlugin,new CopyWebpackPlugin([{from:'client/assets/img',to:'assets/img'}]),new webpack.LoaderOptionsPlugin({minimize:!1,debug:!0,options:{postcss:[autoprefixer({browsers:['last 2 version','Explorer >= 10','Android >= 4']})]}})]};
...
const most = __webpack_require__(29);
const webpack = __webpack_require__(1);
const SocketIOClient = __webpack_require__(30);
const InspectpackDaemon = __webpack_require__(31).daemon;

const serializeError = __webpack_require__(32).serializeError;
...
class DashboardPlugin {
  ...
  getProjectRoot(bundle) {
    ...
    // Try bundle context.
    try {
      if (bundle.context && !(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) {
    ...
    // Try CWD.
    try {
      if (!(function webpackMissingModule() { var e = new Error("Cannot find module \".\""); e.code = 'MODULE_NOT_FOUND'; throw e; }())) {
        return process.cwd();
      }
    } catch (err) { /* passthrough */ }
...
var _ = __webpack_require__(23).runInContext();
module.exports = __webpack_require__(25)(_, _);
...
var mapping = __webpack_require__(26),
    fallbackHolder = __webpack_require__(27);
...
"use strict";
module.exports=[{test:/\.json$/,loader:'json-loader'},{test:/\.js$/,loaders:'babel-loader',exclude:/node_modules/},{test:/\.css$/,loader:'style-loader!css-loader!postcss-loader!sass-loader'},{test:/\.scss$/,loader:'style-loader!css-loader!postcss-loader!sass-loader'},{test:/\.eot(\?v=\d+\.\d+\.\d+)?$/,exclude:/(node_modules|bower_components)/,loader:'file-loader'},{test:/\.(woff|woff2)$/,exclude:/(node_modules|bower_components)/,loader:'url-loader?prefix=font/&limit=5000'},{test:/\.ttf(\?v=\d+\.\d+\.\d+)?$/,exclude:/(node_modules|bower_components)/,loader:'url-loader?limit=10000&mimetype=application/octet-stream'},{test:/\.svg(\?v=\d+\.\d+\.\d+)?$/,exclude:/(node_modules|bower_components)/,loader:'url-loader?limit=10000&mimetype=image/svg+xml'},{test:/\.gif/,exclude:/(node_modules|bower_components)/,loader:'url-loader?limit=10000&mimetype=image/gif'},{test:/\.jpeg/,exclude:/(node_modules|bower_components)/,loader:'url-loader?limit=10000&mimetype=image/jpeg'},{test:/\.png/,exclude:/(node_modules|bower_components)/,loader:'url-loader?limit=10000&mimetype=image/png'},{test:/\.ico$/,loader:'file-loader?name=[name].[ext]'},{test:/\.mp3$/,exclude:/(node_modules|bower_components)/,loader:'file-loader?name=[name].[ext]'}];
